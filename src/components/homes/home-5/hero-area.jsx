...
const hero_contents = {
  ...
  title: 'El Kindy ',
  highlight_text: 'Conservatory',
  short_text: <>Since 1999, El Kindy has been the heartbeat of musical mastery, cultivating prodigious talent with a symphony of expertise and passion.</>,
  ...
  submit_text: 'Join us in our harmonious journey'
}
          ...
          <div className="col-xl-7 col-lg-7">
            <div className="tp-hero-section-box-five">
              ...
              <div className="tp-hero-section-box-five__input wow tpfadeUp" data-wow-duration=".9s" data-wow-delay="1s">
                <Link href="/contact">
                  <a className="tp-btn-sky">{submit_text}</a>
                </Link>              </div>
            </div>
          </div>
